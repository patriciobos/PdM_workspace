...
struct led_data LED; //OJO ESTO ES GLOBAL Y NO ESTA BUENO
delay_t AntyBounceTimmer;
bool TimersUp=false;

debounceState_t FSMState = BUTTON_DOWN;
/* USER CODE BEGIN PFP */
...
int main(void)
{
  ...
  debounceFSM_init(&FSMState);	//Inicializo la FSM
...
void debounceFSM_init(debounceState_t *myFSM){		// debe cargar el estado inicial
