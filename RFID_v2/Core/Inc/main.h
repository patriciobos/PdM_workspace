...
#define LED_DOOR_STATUS_Pin GPIO_PIN_2
#define LED_DOOR_STATUS_GPIO_Port GPIOC
#define LED_USER_FEEDBACK_Pin GPIO_PIN_3
#define LED_USER_FEEDBACK_GPIO_Port GPIOC
#define USART_TX_Pin GPIO_PIN_2
#define USART_TX_GPIO_Port GPIOA
#define USART_RX_Pin GPIO_PIN_3
#define USART_RX_GPIO_Port GPIOA
#define SPI_SDA_GPIO_Pin GPIO_PIN_4
